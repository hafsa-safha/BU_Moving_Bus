...
void cloud(){
    ...
    glPushMatrix();
        ...
        glTranslatef(105,590,70);
        glutSolidSphere(20,36,2);
    glPopMatrix();
    glPushMatrix();
        glTranslatef(82,590,70);
        glutSolidSphere(20,34,2);
    glPopMatrix();
    glPushMatrix();
        glTranslatef(95,610,70);
        glutSolidSphere(20,32,2);
    glPopMatrix();
    glPushMatrix();
        glTranslatef(120,600,70);
        glutSolidSphere(20,30,2);
    glPopMatrix();
    glPushMatrix();
        glTranslatef(70,600,70);
        glutSolidSphere(20,28,2);
    glPopMatrix();
...
void shrubd()
{
    ...
    glColor3f (1, 1, 1); //first cloud
    glPushMatrix();
        //glScalef(Sx+60, 15, 55);
        glTranslatef(305,600,200);
        glutSolidSphere(20,36,2);
    glPopMatrix();
    glPushMatrix();
        glTranslatef(282,600,200);
        glutSolidSphere(20,34,2);
    glPopMatrix();
    glPushMatrix();
        glTranslatef(295,620,200);
        glutSolidSphere(20,32,2);
    glPopMatrix();
    glPushMatrix();
        glTranslatef(320,610,200);
        glutSolidSphere(20,30,2);
    glPopMatrix();
    glPushMatrix();
        glTranslatef(270,610,200);
        glutSolidSphere(20,28,2);
    glPopMatrix();
...
char string[]="University of Barishal";
void *font=GLUT_BITMAP_TIMES_ROMAN_24;
int k;
glColor3f(0.0,0.0,0.0);
...
char string3[]="Hafsa, Nadira Aktar";
...
char string4[]="ID- 16CSE002, 16CSE017";
	...
	switch ( Key )
{
    ...
    case GLUT_KEY_F10: Sx *= 1.1; break;
    case GLUT_KEY_F11: Sx *= 0.9; break;
    default: return;
	}
}
void display(void)
